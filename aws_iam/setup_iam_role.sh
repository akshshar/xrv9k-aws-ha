...
controller_instance_id="i-0bb5f2812b585c3ad"
...
aws ec2 associate-iam-instance-profile --instance-id $controller_instance_id --iam-instance-profile Name=ec2access-profile
